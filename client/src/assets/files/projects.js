...
export default [
  {
    ...
    highlights:
      "React, Express, Nodemailer Form Submission, Media Responsive, ReactCSSTransitionGroup, ReactVerticalTimeline, ReactFontAwesome, CSS Flexbox.",
    deployed: "https://pckearney.herokuapp.com",
